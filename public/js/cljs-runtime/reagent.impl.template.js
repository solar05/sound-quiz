...
var G__34726 = o;
goog.object.set(G__34726,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__34765 = o;
goog.object.set(G__34765,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__35088__i < G__35088__a.length) {G__35088__a[G__35088__i] = arguments[G__35088__i + 0]; ++G__35088__i;}
  args = new cljs.core.IndexedSeq(G__35088__a,0,null);
} 
...
var G__34785 = props;
var G__34785__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34785,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__34785);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34785__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__34785__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__34798 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34798,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__34798;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__34812){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34813__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__34880_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__34880_SHARP_);
}));
} else {
return null;
}
...
var vec__34939 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34939,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34939,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34939,(2),null);
...
var temp__5739__auto___35152 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___35152 == null)){
} else {
var key_35154 = temp__5739__auto___35152;
(jsprops.key = key_35154);
}
...
var temp__5739__auto___35156 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___35156 == null)){
} else {
var key_35158 = temp__5739__auto___35156;
(jsprops.key = key_35158);
}
...
var G__35047 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__35047) : reagent.impl.template.as_element.call(null,G__35047));
} else {
var temp__5739__auto___35173 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___35173 == null)){
} else {
var key_35175 = temp__5739__auto___35173;
(jsprops.key = key_35175);
}
...
var G__35055 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__35055)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__35055)){
return x;
} else {
...
var len__4736__auto___35194 = arguments.length;
var i__4737__auto___35196 = (0);
while(true){
if((i__4737__auto___35196 < len__4736__auto___35194)){
args__4742__auto__.push((arguments[i__4737__auto___35196]));

var G__35205 = (i__4737__auto___35196 + (1));
i__4737__auto___35196 = G__35205;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq35059){
var G__35060 = cljs.core.first(seq35059);
var seq35059__$1 = cljs.core.next(seq35059);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35060,seq35059__$1);
}));
...
break;
default:
var G__35231 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__35231;
continue;
...
var ctx = ({});
var vec__35069 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35069,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35069,(1),null);
...
var G__35075 = (cljs.core.count(argv) - first_child);
switch (G__35075) {
case (0):
