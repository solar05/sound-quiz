...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26370 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26370(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26378 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26378(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26384 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26384(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26385 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26385(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26386 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26386(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26389 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26389(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26390 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26390(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26392 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26392(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26394 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26394(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26397 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26397(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26398 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26398(b);
}
});
